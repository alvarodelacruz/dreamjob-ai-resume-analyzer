        ...
        <>
            ...
            >
                ...
                <div className="w-full max-w-4xl flex flex-col items-center">
                    <CVUpload setCvFile={setCvFile} setCvContent={setCvContent} />
                    <JobURLInput setJobUrl={setJobUrl} setJobContent={setJobContent} />
            ...
            <ChatBot cvContent={cvContent} jobContent={jobContent} />
        </>
    );
};
